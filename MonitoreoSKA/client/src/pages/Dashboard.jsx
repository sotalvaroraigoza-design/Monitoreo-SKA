...
export default function Dashboard({hosts,alerts,onRefresh}){
 ...
 return <><div className="page-heading"><div><h1>Dashboard de monitoreo</h1><p>MonitoreoSKA.</p></div><button className="primary" onClick={onRefresh}>Actualizar</button></div>
