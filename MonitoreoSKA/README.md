...
El proyecto MonitoreoSKA es hecho a base de una arquitectura educativa con **Node.js/Express + React/Vite**.
...
`git branch -M main`
`git remote add origin https://github.com/sotalvaroraigoza-design/Monitoreo-SKA.git`
